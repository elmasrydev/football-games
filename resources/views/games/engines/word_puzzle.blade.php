    ...
    <div class="container play-container">
        <div class="visual-section">
            <div class="puzzle-box">
                ...
                @else
                    <div class="generic-word-puzzle">
                        <p class="puzzle-main-text">{{ $challenge->description ?? $challenge->stimulus_data['description'] ?? 'Solve the puzzle!' }}</p>
                    </div>
                @endif
            </div>
            ...
            <div class="word-description">
                ...
                @elseif($game->slug === 'vowel-void')
                    <p>Fill in the missing vowels!</p>
                @elseif($game->slug === 'missing-link')
                    <p>Find the word that connects both!</p>
                @else
