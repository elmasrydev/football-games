...
@section('content')
    <div class="container play-container">
        <div class="visual-section">
            ...
            <div class="word-description">
                <p>{{ $challenge->question ?? $challenge->stimulus_data['question'] ?? 'What happens in this clip?' }}</p>
            </div>
    ...
    @push('styles')
        <style>
            ...
            .video-box:hover { box-shadow: 0 16px 48px rgba(0, 0, 0, 0.2); }

            .video-container { position: absolute; top: 0; left: 0; width: 100%; height: 100%; overflow: hidden; }
            
            /* Apply filters only in Black and White mode */
            .bw-mode #player, 
            .bw-mode video,
            .bw-mode iframe {
            ...
            .word-description { text-align: center; color: var(--text-dim); font-size: 1.1rem; font-weight: 600; margin-top: 1.5rem; }
