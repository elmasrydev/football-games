...
<div class="space-y-6">
    <div class="relative group">
        ...
        <input type="text" 
               ...
               autocomplete="off"
               class="w-full bg-surface-variant/30 border border-outline-variant/30 rounded-2xl px-6 py-4 text-lg font-display font-black text-on-surface placeholder:text-on-surface-variant/30 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all uppercase tracking-tight">
    ...
    <div class="flex flex-wrap gap-4">
        <button id="submit-btn" class="flex-1 min-w-[160px] bg-primary text-on-primary font-display font-black uppercase tracking-widest py-4 rounded-2xl shadow-xl shadow-primary/20 hover:brightness-110 active:scale-95 transition-all">
            {{ $submitLabel }}
        </button>
