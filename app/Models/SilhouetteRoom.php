...
class SilhouetteRoom extends Model
{
    protected $fillable = [
        'code',
        'owner_id',
    ...
    {
        static::creating(function (SilhouetteRoom $room) {
            if (empty($room->code)) {
    ...
    {
        return $this->hasMany(SilhouettePlayer::class, 'room_id');
    }
    ...
    {
        return $this->hasMany(SilhouetteTeam::class, 'room_id');
    }

    public function roomQuestions(): HasMany
    {
        return $this->hasMany(SilhouetteRoomQuestion::class, 'room_id')->orderBy('question_order');
    }

    public function currentRoomQuestion(): ?SilhouetteRoomQuestion
    {
    ...
    public function getPlayer(int $userId): ?SilhouettePlayer
    {
    ...
    public function getShareLinkAttribute(): string
    {
        ...
        return url("/{$locale}/silhouette/room/{$this->code}");
    }
}
